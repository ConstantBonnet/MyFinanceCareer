...
- Streamlit, Pandas et SQLite.
- Saisie manuelle.
- Documents conserves sous forme de liens externes.
- Pas d'IA, pas d'automatisation complexe, pas de stockage de fichiers.
...
7. Modeles de messages reseau par metier et niveau de seniorite.
